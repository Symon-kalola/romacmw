                ...
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            ...
                            <p class="mb-0">Explore details about our hybrid occapa pine seedlings which can mature
                                just in five years time for timber harvesting. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="service-box">
                            ...
                            <div class="services-list">
                                <a><i class="bi bi-arrow-right-circle"></i><span> Maturity
                                        5years</span></a>
                                <a><i class="bi bi-arrow-right-circle"></i><span>Fast growing</span></a>
                                <a><i class="bi bi-arrow-right-circle"></i><span>Regenerate when
                                        cut</span></a>
                                <a><i class="bi bi-arrow-right-circle"></i><span>Resistant to
                                        drought</span></a>
                                <a><i class="bi bi-arrow-right-circle"></i><span>Recommended for
                                        timber</span></a>
                            </div>
                        ...
                        <div class="service-box">
                            ...
                            <div class="download-catalog">
                                <a><i class="bi bi-filetype-pdf"></i><span>400 000 seedlings
                                        available</span></a>
                                <a><i class="bi bi-file-earmark-word"></i><span>100,000
                                        seedlings</span></a>
                            </div>
                        </div><!-- End Services List -->
                        ...
                        <div class="help-box d-flex flex-column justify-content-center align-items-center">
                            ...
                            <p class="d-flex align-items-center mt-1 mb-0"><i class="bi bi-envelope me-2"></i> <a
                                    href="mailto:contact@example.com">contact@romac.com</a></p>
                        </div>

                    </div>

                    <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ asset('assets/img/t1.jpg') }}" alt="" class="img-fluid services-img">
